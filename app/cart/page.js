...
// TODO: replace accountTitle with the real bank account title once confirmed
// TODO: replace easypaisa number with the real one once available
const PAYMENT_DETAILS = {
  jazzcash: { label: 'JazzCash', number: '0314-8882709', name: 'Alshifa Herbals' },
  easypaisa: { label: 'Easypaisa', number: '03XX-XXXXXXX', name: 'Alshifa Herbals' },
  bank: {
    label: 'Bank Transfer',
    accountTitle: 'Alshifa Herbals', // TODO: confirm real account title
    bankName: 'Bank Al Habib (Islamic Banking) — DHA Phase IV, Lahore',
    iban: 'PK61BAHL5509008101200401',
  },
};
                  ...
                  <form onSubmit={handlePlaceOrder} style={{ marginTop: 16 }}>
                    ...
                    {paymentMethod === 'bank' && (
                      <div style={{ background: 'var(--blush)', borderRadius: 12, padding: 16, marginBottom: 16, fontSize: 13.5 }}>
                        ...
                        <p style={{ margin: '2px 0 0' }}>{PAYMENT_DETAILS.bank.bankName}</p>
